...
| Tau                   | `~/.tau/sessions/`                                                                                                                                                                                                                                   |
| TeleAgent             | `~/.local/share/TeleAgent/users/` (Linux), `~/Library/Application Support/TeleAgent/users/` (macOS), `%LOCALAPPDATA%\\TeleAgent\\users\\` (Windows); first user subdirectory's `teleagent.db` is auto-discovered                                      |
